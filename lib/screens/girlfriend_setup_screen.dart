...
class GirlfriendSetupScreen extends ConsumerStatefulWidget {
  final void Function(GirlfriendConfig config) onComplete;

  const GirlfriendSetupScreen({super.key, required this.onComplete});

  @override
  ConsumerState<GirlfriendSetupScreen> createState() =>
      _GirlfriendSetupScreenState();
}

class _GirlfriendSetupScreenState extends ConsumerState<GirlfriendSetupScreen> {
                  ...
                  showDialog(
                    ...
                    builder:
                        (context) => AlertDialog(
                          ...
                          content: Text(
                            '就寝: ${sleepData['bedtime']} → 起床: ${sleepData['wakeTime']}',
                          ),
                          actions: [
                            TextButton(
                      ...
                      child: BackdropFilter(
                        ...
                        child: Container(
                          ...
                          decoration: BoxDecoration(
                            color: const Color(
                              0xFF1A0A2E,
                            ).withValues(alpha: 0.8), // rgba(26, 10, 46, 0.8)
                            borderRadius: BorderRadius.circular(16),
                            border: Border.all(
                              color: const Color(
                                0xFFFF00FF,
